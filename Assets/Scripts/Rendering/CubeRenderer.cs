...
public class CubeRenderer {
	...
	public static void CubeTop (MeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l)
	{
		...
		bool flip = FlipTriangles (corners[0], corners[1], corners[2], corners[3]);
	...
	public static void CubeNorth (MeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l)
	{
		Vector3 pos = new Vector3 (x, y, z);
		...
		// decide whether to flip triangles
		bool flip = FlipTriangles (corners[2], corners[1], corners[0], corners[3]);

		byte textureID = tex.texNorth;
		PushFace (current, TextureLocation(textureID), corners, flip);
	}
	
	public static void CubeEast (MeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l)
	{
		Vector3 pos = new Vector3 (x, y, z);
		...
		// decide whether to flip triangles
		bool flip = FlipTriangles (corners[3], corners[2], corners[1], corners[0]);

		byte textureID = tex.texEast;
		PushFace (current, TextureLocation(textureID), corners, flip);
	}
	
	public static void CubeSouth (MeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l)
	{
		Vector3 pos = new Vector3 (x, y, z);
		...
		// decide whether to flip triangles
		bool flip = FlipTriangles (corners[1], corners[2], corners[3], corners[0]);

		byte textureID = tex.texSouth;
		PushFace (current, TextureLocation(textureID), corners, flip);
	}
	
	public static void CubeWest (MeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l)
	{
		Vector3 pos = new Vector3 (x, y, z);
		current.vertices.Add (pos + Vertex.bNW(center, size));
		current.vertices.Add (pos + Vertex.tNW(center, size));
	...
	public static void CubeBottom (MeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l)
	{
		Vector3 pos = new Vector3 (x, y, z);
		current.vertices.Add (pos + Vertex.bSW(center, size));
		current.vertices.Add (pos + Vertex.bSE(center, size));
