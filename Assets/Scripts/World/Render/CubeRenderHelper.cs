...
public class CubeRenderHelper
{
    public const byte T_SIZE = 32;
    ...
    public static void CubeNorth(SingleMeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l, bool smooth, Color color)
    {
        Vector3 pos = new Vector3(x, y, z);
    ...
    public static void CubeEast(SingleMeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l, bool smooth, Color color)
    {
        Vector3 pos = new Vector3(x, y, z);
    ...
    public static void CubeSouth(SingleMeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l, bool smooth, Color color)
    {
        Vector3 pos = new Vector3(x, y, z);
    ...
    public static void CubeWest(SingleMeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l, bool smooth, Color color)
    {
        Vector3 pos = new Vector3(x, y, z);
        current.vertices.Add(pos + Vertex.bNW(center, size));
        current.vertices.Add(pos + Vertex.tNW(center, size));
    ...
    public static void CubeBottom(SingleMeshBuildInfo current, int x, int y, int z, TextureLayout tex, Vector3 center, Vector3 size, byte[] l, bool smooth, Color color)
    {
        Vector3 pos = new Vector3(x, y, z);
        current.vertices.Add(pos + Vertex.bSW(center, size));
        current.vertices.Add(pos + Vertex.bSE(center, size));
